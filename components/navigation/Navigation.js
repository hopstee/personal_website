...
function Navigation() {
    ...
    return (
        <div className="fixed bottom-0 md:top-0 left-0 h-auto w-full md:w-auto z-50">
            <div className="md:h-full w-full flex md:flex-col bg-white dark:bg-gray-700 p-2 border-t md:border-r md:border-t-0 border-gray-200 dark:border-gray-600">
                <div className="flex md:inline-flex flex-row md:flex-col justify-evenly space-x-2 md:space-x-0 md:space-y-2 w-full">
                    <Link href="/">
                        <a className="nav-link dark:hover:bg-gray-600">
                    ...
                    <a className="nav-link dark:hover:bg-gray-600" onClick={switchTheme}>
                        {theme === "light" ? (
                            <div>
